...
bool tracer_msgs__msg__tracer_light_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tracer_msgs.msg._tracer_light_state.TracerLightState", full_classname_dest, 52) == 0);
  }
  tracer_msgs__msg__TracerLightState * ros_message = _ros_message;
  {  // mode
...
{
  /* NOTE(esteve): Call constructor of TracerLightState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tracer_msgs.msg._tracer_light_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TracerLightState");
