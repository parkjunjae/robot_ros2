...
class TracerStatus(metaclass=Metaclass_TracerStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.left_odomter = kwargs.get('left_odomter', float())
        self.right_odomter = kwargs.get('right_odomter', float())
    ...
    def __eq__(self, other):
        ...
        if self.front_light_state != other.front_light_state:
            return False
        if self.left_odomter != other.left_odomter:
            return False
        if self.right_odomter != other.right_odomter:
            return False
        return True
    ...
    @builtins.property
    def left_odomter(self):
        """Message field 'left_odomter'."""
        return self._left_odomter

    @left_odomter.setter
    def left_odomter(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'left_odomter' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'left_odomter' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._left_odomter = value

    @builtins.property
    def right_odomter(self):
        """Message field 'right_odomter'."""
        return self._right_odomter

    @right_odomter.setter
    def right_odomter(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'right_odomter' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'right_odomter' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._right_odomter = value
