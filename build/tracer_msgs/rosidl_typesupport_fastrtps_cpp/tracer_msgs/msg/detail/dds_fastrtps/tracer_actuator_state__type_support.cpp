...
#include "tracer_msgs/msg/detail/tracer_actuator_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tracer_msgs::msg::TracerActuatorState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tracer_msgs::msg::TracerActuatorState & ros_message)
{
  // Member: motor_id
  cdr >> ros_message.motor_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tracer_msgs::msg::TracerActuatorState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tracer_msgs::msg::TracerActuatorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tracer_msgs::msg::TracerActuatorState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TracerActuatorState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tracer_msgs::msg::TracerActuatorState *>(
...
static size_t _TracerActuatorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TracerActuatorState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TracerActuatorState__callbacks = {
  "tracer_msgs::msg",
  "TracerActuatorState",
...
static rosidl_message_type_support_t _TracerActuatorState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TracerActuatorState__callbacks,
...
{
  return &tracer_msgs::msg::typesupport_fastrtps_cpp::_TracerActuatorState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tracer_msgs, msg, TracerActuatorState)() {
  return &tracer_msgs::msg::typesupport_fastrtps_cpp::_TracerActuatorState__handle;
}
