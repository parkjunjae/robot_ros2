...
bool tracer_msgs__msg__tracer_rc_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tracer_msgs.msg._tracer_rc_state.TracerRCState", full_classname_dest, 46) == 0);
  }
  tracer_msgs__msg__TracerRCState * ros_message = _ros_message;
  {  // swa
...
{
  /* NOTE(esteve): Call constructor of TracerRCState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tracer_msgs.msg._tracer_rc_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TracerRCState");
