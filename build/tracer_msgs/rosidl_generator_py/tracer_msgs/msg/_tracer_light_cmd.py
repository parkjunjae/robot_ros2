...
class Metaclass_TracerLightCmd(type):
    """Metaclass of message 'TracerLightCmd'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'tracer_msgs.msg.TracerLightCmd')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__tracer_light_cmd
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__tracer_light_cmd
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__tracer_light_cmd
            cls._TYPE_SUPPORT = module.type_support_msg__msg__tracer_light_cmd
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__tracer_light_cmd
    ...
    def LIGHT_CONST_OFF(self):
        ...
        return Metaclass_TracerLightCmd.__constants['LIGHT_CONST_OFF']

    @property
    def LIGHT_CONST_ON(self):
        """Message constant 'LIGHT_CONST_ON'."""
        return Metaclass_TracerLightCmd.__constants['LIGHT_CONST_ON']

    @property
    def LIGHT_BREATH(self):
        """Message constant 'LIGHT_BREATH'."""
        return Metaclass_TracerLightCmd.__constants['LIGHT_BREATH']

    @property
    def LIGHT_CUSTOM(self):
        """Message constant 'LIGHT_CUSTOM'."""
        return Metaclass_TracerLightCmd.__constants['LIGHT_CUSTOM']


class TracerLightCmd(metaclass=Metaclass_TracerLightCmd):
    """
    Message class 'TracerLightCmd'.
