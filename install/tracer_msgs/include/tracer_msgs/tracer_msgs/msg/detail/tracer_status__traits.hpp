...
struct has_fixed_size<tracer_msgs::msg::TracerStatus>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value && has_fixed_size<tracer_msgs::msg::TracerActuatorState>::value && has_fixed_size<tracer_msgs::msg::TracerLightState>::value> {};

template<>
struct has_bounded_size<tracer_msgs::msg::TracerStatus>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value && has_bounded_size<tracer_msgs::msg::TracerActuatorState>::value && has_bounded_size<tracer_msgs::msg::TracerLightState>::value> {};
