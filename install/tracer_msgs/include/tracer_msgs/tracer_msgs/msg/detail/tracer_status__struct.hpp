...
struct TracerStatus_
{
  ...
  using _left_odomter_type =
    double;
  _left_odomter_type left_odomter;
  using _right_odomter_type =
    double;
  ...
  Type & set__left_odomter(
    const double & _arg)
  {
    this->left_odomter = _arg;
    return *this;
  }
  Type & set__right_odomter(
    const double & _arg)
  {
    this->right_odomter = _arg;
    return *this;
  }
  ...
  bool operator==(const TracerStatus_ & other) const
  {
    ...
    if (this->left_odomter != other.left_odomter) {
      return false;
    }
    if (this->right_odomter != other.right_odomter) {
      return false;
    }
    return true;
  }
